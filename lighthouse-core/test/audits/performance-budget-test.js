...
describe('Performance: Resource budgets audit', () => {
  ...
  beforeEach(() => {
    artifacts = {
      ...
      URL: {requestedUrl: 'http://example.com', mainDocumentUrl: 'http://example.com', finalPageUrl: 'http://example.com'},
    };
    ...
    describe('with a matching budget', () => {
      it('applies the correct budget', async () => {
        artifacts = {
          ...
          URL: {requestedUrl: 'http://example.com/file.html', mainDocumentUrl: 'http://example.com/file.html', finalPageUrl: 'http://example.com/file.html'},
        };
        context.settings.budgets = [{
          path: '/',
          resourceSizes: [
